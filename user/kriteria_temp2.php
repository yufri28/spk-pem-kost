                                ...
                                <div class="card-body">
                                    ...
                                    <?php foreach ($dataKriteria as $kriteria) : ?>
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="number" max="100" class="form-control edit-bobot-kriteria" name="e_bobot_kriteria[]" value="<?= ($bobot['C' . $i++] * 100); ?>">
                                        </div>
                                    <?php endforeach; ?>
                                    <button type="button" name="edit" onclick="validateTotal()" class="btn col-12 btn-outline-primary">
                                        Simpan
                                    </button>
                                </div>
                            </form>
                        ...
                        <form method="post" id="kriteriaForm" action="">
                            <div class="card-body">
                                ...
                                <?php foreach ($dataKriteria as $kriteria) : ?>
                                    <div class="mb-3 mt-3">
                                        <label for="bobot_kriteria" class="form-label"><?= $kriteria['nama_kriteria']; ?></label>
                                        <input type="number" max="100" class="form-control bobot-kriteria" name="t_bobot_kriteria[]" value="0">
                                    </div>
                                <?php endforeach; ?>
                                <button type="button" name="simpan" onclick="validateTotal()" class="btn col-12 btn-outline-primary">
                                    Simpan
                                </button>
                            </div>
                        </form>
