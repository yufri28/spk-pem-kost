...
<?php foreach ($dataPenilaian as $nilai) : ?>
    <div class="modal fade" id="edit<?= $nilai['id_alternatif']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <select class="form-select" name="id_alternatif" aria-label="Default select example">
                                    ...
                                    <?php foreach ($dataAlternatif as $alternatif) : ?>
                                        <option <?= $alternatif['id_alternatif'] == $nilai['id_alternatif'] ? 'selected' : ''; ?> value="<?= $alternatif['id_alternatif']; ?>">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <select class="form-select" name="sub_kriteria[]">
                                    ...
                                    <?php foreach ($dataFasilitas as $fasilitas) : ?>
                                        <option <?= $fasilitas['nama_sub_kriteria'] == $nilai['nama_C1'] ? 'selected' : ''; ?> value="<?= $fasilitas['id_sub_kriteria']; ?>">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <select class="form-select" name="sub_kriteria[]">
                                    ...
                                    <?php foreach ($dataJarak as $jarak) : ?>
                                        <option <?= $jarak['nama_sub_kriteria'] == $nilai['nama_C2'] ? 'selected' : ''; ?> value="<?= $jarak['id_sub_kriteria']; ?>">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <select class="form-select" name="sub_kriteria[]">
                                    ...
                                    <?php foreach ($dataBiaya as $biaya) : ?>
                                        <option <?= $biaya['nama_sub_kriteria'] == $nilai['nama_C3'] ? 'selected' : ''; ?> value="<?= $biaya['id_sub_kriteria']; ?>">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <select class="form-select" name="sub_kriteria[]">
                                    ...
                                    <?php foreach ($dataLuasKamar as $luas_kamar) : ?>
                                        <option <?= $luas_kamar['nama_sub_kriteria'] == $nilai['nama_C4'] ? 'selected' : ''; ?> value="<?= $luas_kamar['id_sub_kriteria']; ?>">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <select class="form-select" name="sub_kriteria[]">
                                    ...
                                    <?php foreach ($dataKeamanan as $keamanan) : ?>
                                        <option <?= $keamanan['nama_sub_kriteria'] == $nilai['nama_C5'] ? 'selected' : ''; ?> value="<?= $keamanan['id_sub_kriteria']; ?>">
