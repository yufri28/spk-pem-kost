...
class Alternatif
{
    ...
    public function getDataAlternatif()
    {
        ...
        return $this->db->query("SELECT a.nama_alternatif, a.id_alternatif, a.latitude, a.longitude, a.alamat, a.jenis_kost, a.kecamatan, kak.id_alt_kriteria,
    ...
    public function tambahAlternatif($dataAlternatif, $dataSubKriteria)
    {
        ...
        if ($cekData->num_rows > 0) {
            ...
            $stmtInsertAlt = $this->db->prepare("INSERT INTO alternatif(nama_alternatif, alamat, latitude, longitude,jenis_kost,kecamatan) VALUES (?,?,?,?,?,?)");
            $stmtInsertAlt->bind_param("ssssss", $dataAlternatif['nama_alternatif'], $dataAlternatif['alamat'], $dataAlternatif['latitude'], $dataAlternatif['longitude'], $dataAlternatif['jenis_kost'], $dataAlternatif['kecamatan']);
    ...
    {
        $data = $this->db->query('SELECT kecamatan FROM alternatif');
    ...
    public function editAlternatif($dataAlternatif, $dataSubKriteria)
    {
        ...
        $query = "UPDATE alternatif SET nama_alternatif='" . $dataAlternatif['nama_alternatif'] . "', alamat='" . $dataAlternatif['alamat'] . "', latitude='" . $dataAlternatif['latitude'] . "', longitude='" . $dataAlternatif['longitude'] . "', jenis_kost='" . $dataAlternatif['jenis_kost'] . "', kecamatan='" . $dataAlternatif['kecamatan'] . "' WHERE id_alternatif=" . $dataAlternatif['id_alternatif'];
